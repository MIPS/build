...
arch_version_cflags := -march=mips32
else
ifeq ($(TARGET_ARCH_VERSION),mips32r2)
arch_version_cflags := -march=mips32r2
else
...
# prebuilt/$(HOST_PREBUILT_TAG)/toolchain/mips-xxx/bin/mips-xxx-
$(warning, "No prebuilt toolchain binaries for TOOL_PREFIX")
$(combo_target)TOOLS_PREFIX := \
	/opt/mips-4.3/bin/mips-linux-gnu-
endif

$(combo_target)CC := $($(combo_target)TOOLS_PREFIX)gcc$(HOST_EXECUTABLE_SUFFIX) -EL -Ulinux
$(combo_target)CXX := $($(combo_target)TOOLS_PREFIX)g++$(HOST_EXECUTABLE_SUFFIX) -EL -Ulinux
...
TARGET_mips_debug_CFLAGS := $(TARGET_mips_release_CFLAGS) -fno-omit-frame-pointer -fno-strict-aliasing
