...
# Read the values from something like TARGET_(mips)_release_CFLAGS or
# TARGET_(mips)_debug_CFLAGS.  HOST_(mips)_(release|debug)_CFLAGS
# values aren't actually used (although they are usually empty).
arch_objects_cflags := $($(my_prefix)$(arch_objects_mode)_$($(my_prefix)BUILD_TYPE)_CFLAGS)
